public class TesteConsultaAgendada {
    public static void main(String[] args) {
        ...
        // Usando o construtor ConsultaAgendada (int h, int mi, int s, int d, int m, int a, String p, String m1)
        ...
        System.out.println("----------------------------------------------------");
        int total = p1.getAmostra() +p2.getAmostra();
        System.out.println("Quantidade final de consultas agendadas: " + total);
        System.out.println("1 " +  p1.getAmostra());
        System.out.println("2 " +  p2.getAmostra());
    }
}
