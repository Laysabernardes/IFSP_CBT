        ...
        <div class="card">
            ...
            <form action="${linkServletNovoProduto}" method="post">
                ...
                <label>Unidade Compra:
                    <input type="number" name="unidadeCompra" value="" required />
                </label>
                <label>Descrição:
                    <input type="text" name="descricao" value="" required />
                </label>
                <label>Qtd Previsto Mes:
                    <input type="number" name="qtdPrevistoMes" value="" required />
                </label>
                <label>Preço Max Comprado:
                    <input type="number" name="precoMaxComprado" value="" required step="0.01" />
                </label>
