...
public class ExchangeRatesServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (currencyPair == null) {
            try {
                ...
                e.printStackTrace();
                throw new ServletException("Erro de banco de dados ao buscar preferência.", e);
            }
        }
    ...
    private void showCurrencyRate(HttpServletResponse resp, String currencyPair) throws IOException {
        ...
        writer.write("<body>");
        writer.write("<header>");
        writer.write("<a href='currencySelection.html' style='text-decoration:none;'><h1>Cotação de Moedas</h1></a>");
        writer.write("<nav class='menu'><a href='currencySelection.jsp'>Seleção de Moeda</a><a href='credito.jsp'>Créditos</a></nav>");
        writer.write("</header>");
        writer.write("<main>");
        writer.write("<div class='card'>");
        writer.write("<h2>Cotação de Exemplo</h2>");
        writer.write(String.format("<p>A taxa de câmbio para <strong>%s</strong> é</p>", currencyPair));
        writer.write(String.format("<p style='font-size: 2em; color: #2e7d32; margin: 10px 0;'>%d</p>", rate));
        writer.write("<a href='remove-currency-pair' class='botao-voltar'>Remover Preferência</a>");
        writer.write("</div>");
        writer.write("</main>");
        writer.write("<footer>Desenvolvido por Laysa Bernardes e Lucas Lopes </footer>");
        writer.write("</body>");
        writer.write("</html>");
